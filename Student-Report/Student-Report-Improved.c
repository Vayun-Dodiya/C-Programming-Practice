/*
    student-report-improved.c - 
    This is an improved version of the original student report program. It includes better file handling, more robust searching and deleting functionality, and a cleaner user interface. The program allows users to add, view, and remove student details stored in a text file.
